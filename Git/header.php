...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Mar 2022 05:50:59 GMT -->
<head>
      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link active" href="javascript:void(0)">Default</a>
                <a class="nav-link " href="javascript:void(0)">Alternative</a>
              </div>
            </div>
            <!-- End Collapse -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <a class="nav-link " href="javascript:void(0)">Add User <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                </div>
              </div>
              <!-- End Collapse -->
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <a class="nav-link " href="javascript:void(0)">Connections</a>
                  <a class="nav-link " href="javascript:void(0)">My Profile</a>
                </div>
              </div>
              <!-- End Collapse -->
                  ...
                  <div id="navbarVerticalMenuPagesMenuEcommerce">
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuPagesEcommerceProductsMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        ...
                        <a class="nav-link " href="javascript:void(0)">Product Details</a>
                        <a class="nav-link " href="javascript:void(0)">Add Product</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuPagesEcommerceOrdersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        ...
                        <a class="nav-link " href="javascript:void(0)">Order Details</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuPagesEcommerceCustomersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        ...
                        <a class="nav-link " href="javascript:void(0)">Customer Details</a>
                        <a class="nav-link " href="javascript:void(0)">Add Customers</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
                  </div>

                  <a class="nav-link " href="javascript:void(0)">Referrals</a>
                  <a class="nav-link " href="javascript:void(0)">Manage Reviews</a>
                  <a class="nav-link " href="javascript:void(0)">Checkout</a>
                </div>
              </div>
              <!-- End Collapse -->
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesProjectMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link " href="javascript:void(0)">Overview</a>
                  <a class="nav-link " href="javascript:void(0)">Files</a>
                  <a class="nav-link " href="javascript:void(0)">Activity</a>
                  <a class="nav-link " href="javascript:void(0)">Teams</a>
                  <a class="nav-link " href="javascript:void(0)">Settings</a>
                </div>
              </div>
                  ...
                  <div id="navbarVerticalMenuAuthenticationMenu">
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuAuthenticationLoginMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                        ...
                        <a class="nav-link " href="javascript:void(0)">Cover</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
                    ...
                    <a class="nav-link " href="javascript:void(0)">Error 404</a>
                    <a class="nav-link " href="javascript:void(0)">Error 500</a>
                  </div>
                </div>
              </div>
              <!-- End Collapse -->
          ...
          ?>
            ...
            <div class="nav-item">
              <a class="nav-link " href="product.php" data-placement="left">
            ...
            <div class="nav-item">
              <a class="nav-link " href="category.php" data-placement="left">
            ...
            <div class="nav-item">
              <a class="nav-link " href="attribute.php" data-placement="left">
                <i class="bi-receipt nav-icon"></i>
                <span class="nav-link-title">Attribute </span>
              </a>
            </div>

            <div class="nav-item">
              <a class="nav-link " href="purchasebill.php" data-placement="left">
                <i class="bi-folder2-open nav-icon"></i>
                <span class="nav-link-title">PurchaseBill</span>
              </a>
            </div>

            <span class="dropdown-header mt-4">Masters</span>
            <small class="bi-three-dots nav-subtitle-replacer"></small>

            <div class="nav-item">
              <a class="nav-link " href="addcategory.php" data-placement="left">
